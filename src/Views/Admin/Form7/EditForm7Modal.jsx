...
const EditForm7Modal = ({ editModal, setEditModal, form7id, attributes }) => {
  ...
  const initialFormState = {
    ...
    form7collection: attributes.form7collection,
  };
  ...
  const onSubmit = async (form7id) => {
    try {
      await axios.put(`${api}/api/form7s/${form7id}`, {
        data: form7Inputs,
      });
