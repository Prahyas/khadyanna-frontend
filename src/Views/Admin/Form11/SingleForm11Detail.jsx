...
const SingleForm11Detail = ({
  ...
  const monthsArray = attributes.form11collection.map((item) => {
    const month = item.form11months;
            ...
            <div ref={componentRef} class='p-6 space-y-5'>
              ...
              <div class='relative overflow-x-auto shadow-md sm:rounded-lg'>
                <table class=' mb-5 w-full text-sm text-left text-gray-700 dark:text-gray-400'>
                  ...
                  <tbody>
                    {attributes.form11collection.map((collectiondata) => {
                      const month = collectiondata.form11months;
                      ...
                      return (
                        <>
                          <tr class='border-b dark:bg-gray-800 dark:border-gray-700 odd:bg-white even:bg-gray-50 odd:dark:bg-gray-800 even:dark:bg-gray-700'>
                            ...
                            <td class='px-2 py-2'>
                              {collectiondata.form11months.shrawan}
                            </td>
                            <td class='px-2 py-2'>
                              {collectiondata.form11months.bhadra}
                            </td>
                            <td class='px-2 py-2'>
                              {collectiondata.form11months.ashwin}
                            </td>
                            <td class='px-2 py-2'>
                              {collectiondata.form11months.kartik}
                            </td>
                            <td class='px-2 py-2'>
                              {collectiondata.form11months.mangsir}
                            </td>
                            <td class='px-2 py-2'>
                              {collectiondata.form11months.poush}
                            </td>
                            <td class='px-2 py-2'>
                              {collectiondata.form11months.magh}
                            </td>
                            <td class='px-2 py-2'>
                              {collectiondata.form11months.falgun}
                            </td>
                            <td class='px-2 py-2'>
                              {collectiondata.form11months.chaitra}
                            </td>
                            <td class='px-2 py-2'>
                              {collectiondata.form11months.baisakh}
                            </td>
                            <td class='px-2 py-2'>
                              {collectiondata.form11months.jestha}
                            </td>
                            <td class='px-2 py-2'>
                              {collectiondata.form11months.ashar}
                            </td>

                            <td class='px-2 py-2'>
                              {collectiondata.form11months.mahinapragati}
                            </td>
                            <td class='px-2 py-2'>
                              {collectiondata.form11months.namunasankhya}
                            </td>
                            <td class='px-2 py-2'>
                              {collectiondata.form11months.parameter}
                            </td>
                            <td class='px-2 py-2'>
                              {collectiondata.form11months.pragati}
                            </td>
                            <td class='px-2 py-2'>
                              {collectiondata.form11months.pragatipercent}
                            </td>
                            <td class='border-l-2 border-l-gray-400 px-2 py-2 break-after-auto'>
                              {collectiondata.form11months.kaifiyat}
                            </td>
                          </tr>
                        </>
                      );
                      ...
                      {columnTotal.map((item) => {
                        return (
                          <>
                            ...
                            <td class='px-2 py-2'>{item.mahinapragati}</td>
                            <td class='px-2 py-2'>{item.namunasankhya}</td>
                            <td class='px-2 py-2'>{item.parameter}</td>
                ...
                >
                  ...
                  <tbody>
                    <tr>
                      <td class=' px-2 py-2'> आयात निर्यात गुण प्रमाणिकरण</td>
...
export default SingleForm11Detail;
