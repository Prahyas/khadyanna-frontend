...
const EditForm19Modal = ({ editModal, setEditModal, form19id, attributes }) => {
  ...
  const onSubmit = async (form19id) => {
    try {
      await axios.put(`${api}/api/form19s/${form19id}`, {
        data: form19Inputs,
      });
        ...
        <div className=' w-full h-[15%] border-t-2 flex items-center p-5'>
          <div className='flex'>
            <button
              ...
              disabled={!form19Inputs.arthikbarsha || form19Inputs.date === ''}
            >
              पेश गर्नुहोस्
            </button>
            <button
...
export default EditForm19Modal;
