            ...
            <div ref={componentRef} class='p-6 space-y-5'>
              ...
              <div className='mb-5 flex justify-between text-black '>
                ...
                <div className='flex flex-col'>
                  ...
                  <span className='mb-2'> सप्ताह : {attributes.saptaha}</span>
                </div>
              </div>
              ...
              <div class='relative overflow-x-auto shadow-md sm:rounded-lg'>
                <table class=' mb-5 w-full text-sm text-left text-gray-700 dark:text-gray-400'>
                  ...
                  <tbody>
                    {attributes.form15collection.map((collectiondata) => {
                      return (
                        <>
                          <tr class='border-b dark:bg-gray-800 dark:border-gray-700 odd:bg-white even:bg-gray-50 odd:dark:bg-gray-800 even:dark:bg-gray-700'>
                            <td class='font-bold px-2 py-2 '>
                              {collectiondata.form15months.udhyognamthegana}
                            </td>
                            <td class='px-2 py-2'>
                              {collectiondata.form15months.bastukonam}
                            </td>
                            <td class='px-2 py-2'>
                              {collectiondata.form15months.sankalanmiti}
                            </td>
                            <td class='px-2 py-2'>
                              {collectiondata.form15months.sankalansthan}
                            </td>
                            <td class='px-2 py-2'>
                              {collectiondata.form15months.khani}
                            </td>
                            <td class='px-2 py-2'>
                              {collectiondata.form15months.peshgarekomiti}
                            </td>
                            <td class='px-2 py-2'>
                              {collectiondata.form15months.bishlesanmiti}
                            </td>
                            <td class='px-2 py-2'>
                              {collectiondata.form15months.prakar}
                            </td>
                            <td class='px-2 py-2'>
                              {collectiondata.form15months.parameter}
                            </td>
                            <td class='px-2 py-2'>
                              {collectiondata.form15months.dayarsthan}
                            </td>
                            <td class='px-2 py-2'>
                              {collectiondata.form15months.dayarmiti}
                            </td>
                            <td class='px-2 py-2'>
                              {collectiondata.form15months.dayargarnekhani}
                            </td>
                            <td class=' px-2 py-2'>
                              {collectiondata.form15months.dayargarnekaryalaya}
                            </td>

                            <td class='border-l-2 border-l-gray-400 px-2 py-2 break-after-auto'>
                              {collectiondata.form15months.kaifiyat}
                            </td>
                          </tr>
                        </>
                      );
                ...
                >
                  ...
                  <tbody>
                    <tr>
                      <td class=' px-2 py-2'> मुद्दा दायरी विवरण</td>
...
export default SingleForm15Detail;
